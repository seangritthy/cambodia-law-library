...
const files = [
    'C:\\Users\\seang\\.gemini\\antigravity\\brain\\79f4c6b2-9f37-4325-be76-1ddeb8f3cf68\\.system_generated\\steps\\938\\content.md',
    'C:\\Users\\seang\\.gemini\\antigravity\\brain\\79f4c6b2-9f37-4325-be76-1ddeb8f3cf68\\.system_generated\\steps\\953\\content.md'
];
    ...
    if (fs.existsSync(file)) {
        ...
        $('a').each((i, el) => {
            ...
            if (href.toLowerCase().includes('.pdf')) {
                ...
                count++;
                pdfs.push({ title: text || 'Law ' + count, url: fullUrl, file: `law_ij_${count}.pdf` });
            }
        });
    }
});

console.log('Total found on pages I and J:', count);
